 ...
 * trigger.
 */
enum class Mode { BATTERY_SAVER, STANDARD, SESSION }
 ...
 * @property continuous whether the mode streams continuously once armed
 *   (true only for [Mode.SESSION]) rather than waiting for a trigger.
 */
