...
const METRICS = {{
  ...
  dose_per_hour:   {{label:"buzzes per hour the wrist would deliver — the ladder BEFORE hold-3s (2026-09-20), kept as the baseline every variant below is compared against", good:"low"}},
  ...
  dose_sustained3s: {{label:"dose with the first rung HELD for 3 s before a buzz — SHIPPED 2026-09-20 (docs/plans/2026-09-20-hold3-hysteresis.md)", good:"low"}},
